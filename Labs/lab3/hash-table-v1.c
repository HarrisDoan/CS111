...
struct hash_table_v1 *hash_table_v1_create()
{
	...
	//Mutex: Init
	int mutex_status = pthread_mutex_init(&hash_table-> mutex, NULL);
                             ...
                             uint32_t value)
{
	...
	//Mutex: Lock
	int mutex_status = pthread_mutex_lock(&hash_table -> mutex);
	...
	//Add else since we don't want this to always run
	else
	{
	...
	//Mutex: Unlock
	mutex_status = pthread_mutex_unlock(&hash_table->mutex);
...
void hash_table_v1_destroy(struct hash_table_v1 *hash_table)
{
	...
	//Mutex: Destroy
	int mutex_status = pthread_mutex_destroy(&hash_table->mutex);
